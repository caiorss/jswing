...
# Library sources 
libsrc := src/jswing.scala src/jswing.widgets.scala src/jswing.builder.scala src/jswing.guis.scala src/jswing.panel.scala src/canvas.scala src/jswing.main.scala
